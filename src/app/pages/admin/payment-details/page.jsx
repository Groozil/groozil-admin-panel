  ...
  return (
    <div className="min-h-screen bg-[#EEF2F6] text-[#212529] flex">
      ...
      <div className="flex-1 flex flex-col">
        <Navbar
          title="Paymets & Wallets"
          subTitle="Manage transactions, refunds and user wallets"
        />
        ...
        <main className="p-6 space-y-6">
          ...
          <div className="p-6 bg-[#EEF2F6] rounded-xl shadow-md">
            ...
            {isShow == "transactions" ? (
                    ...
                    <tbody>
                      {customers.map((c) => (
                        ...
                        >
                          ...
                          <td className="p-3 text-gray-600">Card</td>
              ...
              <UserWallet customers={customers} />
            ) : isShow == "refund" ? (
              <Refunds customers={customers} />
            ) : (
              ""
            )}
          </div>
